...
![Setting the SSM Parameter for S3 bucket name](ssm.png)
...
![Loading sample data into MongoDB Atlas](atlassandbox.png)
...
![Creating a MongoDB Realm App](createrealmapp.png)
...
![Setting up the Access Key ID as a Realm Value](realmvalue1.png)
...
![Setting up the Secret Key as a Realm Secret](realmsecret.png)
...
![Linking a Realm Value to the Realm Secret](realmvalue2.png)
...
![Adding the aws-sdk library as a dependency](realmnpmlibrary.png)
...
![Configuring the Realm Function](realmfunction1.png)

![Editing the code of the Realm Function](realmfunction2.png)
...
![Configuring the Realm Trigger Part 1](realmtrigger1.png)

![Configuring the Realm Trigger Part 2](realmtrigger2.png)
...
![Seeing the log output showing a successful upload](logoutput.png)
...
![Seeing the document show up in S3](s3result.png)
