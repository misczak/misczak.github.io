...
date: 2022-05-30
description: Generating temperature and humidity time series data and using MongoDB's time series collections, charts and window functions to analyze it. 
...
![Documents populating the time series collection](tscollectionview.png)
...
![Using the time series collection as a Charts data source](chartsdatasource.png)
...
![The Current Temperature Chart Configuration](currenttemp.png)
...
![The Last Hour Average Temperature Chart Configuration](averagetemp.png)
...
![Visualization of the Hourly Change in Temperature](changeintemp.png)
...
![The Complete Dashboard of Temperature and Humidity Data](completedashboard.png)